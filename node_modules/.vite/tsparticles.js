...
function calcPositionOrRandomFromSize(data) {
  var _a, _b, _c, _d;
  return {
    x: ((_b = (_a = data.position) == null ? void 0 : _a.x) != null ? _b : getRandom() * percentDenominator) * data.size.width / percentDenominator,
    y: ((_d = (_c = data.position) == null ? void 0 : _c.y) != null ? _d : getRandom() * percentDenominator) * data.size.height / percentDenominator
  };
}
...
function isPointInside(point, size, offset, radius, direction) {
  const minRadius6 = 0;
  return areBoundsInside(calculateBounds(point, radius != null ? radius : minRadius6), size, offset, direction);
}
...
function updateAnimation(particle, data, changeDirection, destroyType, delta) {
  ...
  if (particle.destroyed || !data || !data.enable || ((_a = data.maxLoops) != null ? _a : minLoops2) > minLoops2 && ((_b = data.loops) != null ? _b : minLoops2) > ((_c = data.maxLoops) != null ? _c : minLoops2)) {
    return;
  }
  const velocity = ((_d = data.velocity) != null ? _d : minVelocity8) * delta.factor, minValue = data.min, maxValue = data.max, decay = (_e = data.decay) != null ? _e : minDecay;
  if (!data.time) {
    data.time = 0;
  }
  if (((_f = data.delayTime) != null ? _f : minDelay) > minDelay && data.time < ((_g = data.delayTime) != null ? _g : minDelay)) {
    data.time += delta.value;
  }
  if (((_h = data.delayTime) != null ? _h : minDelay) > minDelay && data.time < ((_i = data.delayTime) != null ? _i : minDelay)) {
    return;
  }
  switch (data.status) {
...
function updateColorValue(data, range, decrease, delta) {
  ...
  if (!data || !data.enable || ((_a = data.maxLoops) != null ? _a : minLoops2) > minLoops2 && ((_b = data.loops) != null ? _b : minLoops2) > ((_c = data.maxLoops) != null ? _c : minLoops2)) {
    return;
  }
  if (!data.time) {
    data.time = 0;
  }
  if (((_d = data.delayTime) != null ? _d : minDelay) > minDelay && data.time < ((_e = data.delayTime) != null ? _e : minDelay)) {
    data.time += delta.value;
  }
  if (((_f = data.delayTime) != null ? _f : minDelay) > minDelay && data.time < ((_g = data.delayTime) != null ? _g : minDelay)) {
    return;
  }
  const offset = data.offset ? randomInRange(data.offset) : minOffset, velocity = ((_h = data.velocity) != null ? _h : minVelocity8) * delta.factor + offset * velocityFactor, decay = (_i = data.decay) != null ? _i : identity8, max = getRangeMax(range), min = getRangeMin(range);
  ...
  constructor(absorbers, container, engine, options, position) {
    ...
    this._updateParticlePosition = (particle, v) => {
      ...
      if (this.options.orbits) {
        ...
        particle.absorberOrbit.angle += ((_a2 = particle.retina.moveSpeed) != null ? _a2 : minVelocity2) * container2.retina.pixelRatio / percentDenominator * container2.retina.reduceFactor;
      } else {
    ...
    this.color = (_a = rangeColorToRgb(this._engine, this.options.color)) != null ? _a : {
      b: 0,
      g: 0,
      r: 0
    };
    this.position = (_c = (_b = this.initialPosition) == null ? void 0 : _b.copy()) != null ? _c : this._calcPosition();
  }
  attract(particle) {
...
var Absorbers = class {
  constructor(container, engine) {
    ...
    container.getAbsorber = (idxOrName) => idxOrName === void 0 || isNumber(idxOrName) ? this.array[idxOrName != null ? idxOrName : defaultIndex] : this.array.find((t) => t.name === idxOrName);
  ...
  handleClickMode(mode) {
    ...
    if (mode === AbsorberClickMode.absorber) {
      const absorbersModeOptions = itemFromSingleOrMultiple(modeAbsorbers), absorbersOptions = absorbersModeOptions != null ? absorbersModeOptions : itemFromSingleOrMultiple(absorberOptions), aPosition = this._container.interactivity.mouse.clickPosition;
...
var Split = class {
  ...
  load(data) {
    ...
    if (data.colorOffset) {
      this.colorOffset = (_a = this.colorOffset) != null ? _a : {};
...
function addSplitParticle(engine, container, parent, splitParticlesOptions) {
  ...
  if (splitOptions.color) {
    ...
    options.color.load({
      value: {
        hsl: {
          h: parentColor.h + getRangeValue((_a = splitOptions.colorOffset.h) != null ? _a : defaultOffset),
          s: parentColor.s + getRangeValue((_b = splitOptions.colorOffset.s) != null ? _b : defaultOffset),
          l: parentColor.l + getRangeValue((_c = splitOptions.colorOffset.l) != null ? _c : defaultOffset)
        }
      }
    });
  } else {
  ...
  return container.particles.addParticle(position, options, parent.group, (particle) => {
    ...
    particle.splitCount = ((_a2 = parent.splitCount) != null ? _a2 : defaultSplitCount) + increment;
...
var EmitterShape = class {
  ...
  load(data) {
    ...
    if (data.options !== void 0) {
      this.options = deepExtend({}, (_a = data.options) != null ? _a : {});
    }
...
var EmitterInstance = class {
  constructor(engine, emitters, container, options, position) {
    ...
    this._setColorAnimation = (animation, initValue, maxValue, factor = defaultColorAnimationFactor) => {
      ...
      const colorOffset = randomInRange(animation.offset), delay = getRangeValue(this.options.rate.delay), emitFactor = delay * millisecondsToSeconds / container2.retina.reduceFactor, defaultColorSpeed = 0, colorSpeed = getRangeValue((_a2 = animation.speed) != null ? _a2 : defaultColorSpeed);
    ...
    this._spawnDelay = getRangeValue((_a = this.options.life.delay) != null ? _a : defaultLifeDelay) * millisecondsToSeconds / this.container.retina.reduceFactor;
    this.position = (_b = this._initialPosition) != null ? _b : this._calcPosition();
    this.name = this.options.name;
    this.fill = this.options.fill;
    this._firstSpawn = !this.options.life.wait;
    this._startParticlesAdded = false;
    let particlesOptions = deepExtend({}, this.options.particles);
    particlesOptions != null ? particlesOptions : particlesOptions = {};
    (_c = particlesOptions.move) != null ? _c : particlesOptions.move = {};
    (_e = (_d = particlesOptions.move).direction) != null ? _e : _d.direction = this.options.direction;
    ...
    this._lifeCount = (_f = this.options.life.count) != null ? _f : defaultLifeCount;
    ...
    const shapeOptions = this.options.shape, shapeGenerator = (_g = this._engine.emitterShapeManager) == null ? void 0 : _g.getShapeGenerator(shapeOptions.type);
    if (shapeGenerator) {
  ...
  play() {
    ...
    if (!(this.container.retina.reduceFactor && (this._lifeCount > minLifeCount || this._immortal || !this.options.life.count) && (this._firstSpawn || this._currentSpawnDelay >= ((_a = this._spawnDelay) != null ? _a : defaultSpawnDelay)))) {
      return;
    }
  ...
  update(delta) {
    ...
    if (this._firstSpawn) {
      ...
      this._currentSpawnDelay = (_a = this._spawnDelay) != null ? _a : defaultSpawnDelay;
      this._currentEmitDelay = (_b = this._emitDelay) != null ? _b : defaultEmitDelay;
    }
    ...
    if (this._duration !== void 0) {
      ...
      if (this._currentDuration >= this._duration) {
        ...
        if (this._lifeCount > minLifeCount || this._immortal) {
          ...
          (_c = this._shape) == null ? void 0 : _c.resize(this.position, this.size);
          this._spawnDelay = getRangeValue((_d = this.options.life.delay) != null ? _d : defaultLifeDelay) * millisecondsToSeconds / this.container.retina.reduceFactor;
        } else {
          this._destroy();
        }
  ...
  _calcSize() {
    ...
    return (_a = this.options.size) != null ? _a : (() => {
...
var Emitters = class {
  constructor(engine, container) {
    ...
    const defaultIndex2 = 0;
    container.getEmitter = (idxOrName) => idxOrName === void 0 || isNumber(idxOrName) ? this.array[idxOrName != null ? idxOrName : defaultIndex2] : this.array.find((t) => t.name === idxOrName);
  ...
  handleClickMode(mode) {
    ...
    const emittersOptions = emittersModeOptions != null ? emittersModeOptions : emitterOptions, ePosition = this.container.interactivity.mouse.clickPosition;
      ...
      if (isArray(interactivityEmitters)) {
        ...
        if (emitterMode.value !== void 0) {
          ...
          if (isArray(emitterMode.value)) {
            options.interactivity.modes.emitters = {
              random: {
                count: (_c = emitterMode.random.count) != null ? _c : defaultCount,
                enable: (_d = emitterMode.random.enable) != null ? _d : false
              },
            ...
            options.interactivity.modes.emitters = {
              random: {
                count: (_e = emitterMode.random.count) != null ? _e : defaultCount,
                enable: (_f = emitterMode.random.enable) != null ? _f : false
              },
              value: tmp
            };
          }
...
var TrailMaker = class extends ExternalInteractorBase {
  ...
  interact(delta) {
    ...
    if (mousePos) {
      this._lastPosition = __spreadValues({}, mousePos);
    } else {
...
function applyDistance(particle) {
  ...
  const hasHDistance = (_a = hDistance && dxFixed >= hDistance) != null ? _a : false, hasVDistance = (_b = vDistance && dyFixed >= vDistance) != null ? _b : false;
...
function initSpin(particle) {
  ...
  const spinPos = (_a = spinOptions.position) != null ? _a : { x: 50, y: 50 }, spinFactor2 = 0.01, spinCenter = {
...
var BaseMover = class {
  ...
  move(particle, delta) {
    ...
    (_b = (_a = particle.retina).moveSpeed) != null ? _b : _a.moveSpeed = getRangeValue(moveOptions.speed) * pxRatio;
    (_d = (_c = particle.retina).moveDrift) != null ? _d : _c.moveDrift = getRangeValue(particle.options.move.drift) * pxRatio;
    const slowFactor = getProximitySpeedFactor(particle), baseSpeed = particle.retina.moveSpeed * container.retina.reduceFactor, moveDrift = particle.retina.moveDrift, maxSize = getRangeMax(particleOptions.size.value) * pxRatio, sizeFactor2 = moveOptions.size ? particle.getRadius() / maxSize : defaultSizeFactor, deltaFactor = delta.factor || defaultDeltaFactor, moveSpeed = baseSpeed * sizeFactor2 * slowFactor * deltaFactor / diffFactor, maxSpeed = (_e = particle.retina.maxSpeed) != null ? _e : container.retina.maxSpeed;
...
var OpacityUpdater = class {
  ...
  isEnabled(particle) {
    var _a, _b, _c, _d;
    const none2 = 0;
    return !particle.destroyed && !particle.spawning && !!particle.opacity && particle.opacity.enable && (((_a = particle.opacity.maxLoops) != null ? _a : none2) <= none2 || ((_b = particle.opacity.maxLoops) != null ? _b : none2) > none2 && ((_c = particle.opacity.loops) != null ? _c : none2) < ((_d = particle.opacity.maxLoops) != null ? _d : none2));
  }
  reset(particle) {
    if (particle.opacity) {
...
var NoneOutMode = class {
  ...
  update(particle, direction, delta, outMode) {
    ...
    if ((_a = particle.options.move.distance.horizontal && (direction === OutModeDirection.left || direction === OutModeDirection.right)) != null ? _a : particle.options.move.distance.vertical && (direction === OutModeDirection.top || direction === OutModeDirection.bottom)) {
      return;
    }
...
var OutOfCanvasUpdater = class {
  ...
  update(particle, delta) {
    var _a, _b, _c, _d;
    const outModes = particle.options.move.outModes;
    this._updateOutMode(particle, delta, (_a = outModes.bottom) != null ? _a : outModes.default, OutModeDirection.bottom);
    this._updateOutMode(particle, delta, (_b = outModes.left) != null ? _b : outModes.default, OutModeDirection.left);
    this._updateOutMode(particle, delta, (_c = outModes.right) != null ? _c : outModes.default, OutModeDirection.right);
    this._updateOutMode(particle, delta, (_d = outModes.top) != null ? _d : outModes.default, OutModeDirection.top);
  }
};
...
var SizeUpdater = class {
  init(particle) {
    ...
    if (sizeAnimation.enable) {
      particle.size.velocity = ((_a = particle.retina.sizeAnimationSpeed) != null ? _a : container.retina.sizeAnimationSpeed) / percentDenominator * container.retina.reduceFactor;
  ...
  isEnabled(particle) {
    var _a, _b, _c, _d;
    return !particle.destroyed && !particle.spawning && particle.size.enable && (((_a = particle.size.maxLoops) != null ? _a : minLoops) <= minLoops || ((_b = particle.size.maxLoops) != null ? _b : minLoops) > minLoops && ((_c = particle.size.loops) != null ? _c : minLoops) < ((_d = particle.size.maxLoops) != null ? _d : minLoops));
  }
  reset(particle) {
...
var EmojiDrawer = class {
  ...
  particleInit(_container, particle) {
    ...
    const emojiOptions = typeof emoji === "string" ? {
      font: (_a = shapeData.font) != null ? _a : defaultFont,
      padding: (_b = shapeData.padding) != null ? _b : noPadding,
      value: emoji
...
var Bubbler = class extends ExternalInteractorBase {
  constructor(container, engine) {
    ...
    this._clickBubble = () => {
      ...
      for (const particle of query) {
        ...
        const pos = particle.getPosition(), distMouse = getDistance(pos, mouseClickPos), timeSpent = (new Date().getTime() - ((_a = container2.interactivity.mouse.clickTime) != null ? _a : defaultClickTime)) / millisecondsToSeconds;
        ...
        const opacityData = {
          ...
          particlesObj: {
            ...
            value: (_c = (_b = particle.opacity) == null ? void 0 : _b.value) != null ? _c : defaultOpacity2
          },
    ...
    this._hoverBubbleOpacity = (particle, ratio, divBubble) => {
      ...
      const optOpacity = particle.options.opacity.value, pOpacity = (_d = (_c = particle.opacity) == null ? void 0 : _c.value) != null ? _d : defaultOpacity2, opacity = calculateBubbleValue(pOpacity, modeOpacity, getRangeMax(optOpacity), ratio);
      if (opacity !== void 0) {
    ...
    this._process = (particle, distMouse, timeSpent, data) => {
      ...
      const bubbleDuration = bubbleOptions.duration, bubbleDistance = container2.retina.bubbleModeDistance, particlesParam = data.particlesObj.optValue, pObjBubble = data.bubbleObj.value, pObj = (_a = data.particlesObj.value) != null ? _a : defaultBubbleValue, type = data.type;
  ...
  isEnabled(particle) {
    var _a;
    const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = ((_a = particle == null ? void 0 : particle.interactivity) != null ? _a : options.interactivity).events, { onClick, onDiv, onHover } = events, divBubble = isDivModeEnabled(bubbleMode, onDiv);
...
function drawConnection(container, p1, p2) {
  container.canvas.draw((ctx) => {
    ...
    drawConnectLine(ctx, (_a = p1.retina.linksWidth) != null ? _a : defaultLinksWidth, ls, pos1, pos2);
  });
}
...
function drawGrab(container, particle, lineColor, opacity, mousePos) {
  container.canvas.draw((ctx) => {
    ...
    drawGrabLine(ctx, (_a = particle.retina.linksWidth) != null ? _a : defaultWidth, beginPos, mousePos, lineColor, opacity);
  });
}
...
var Repulser = class extends ExternalInteractorBase {
  constructor(engine, container) {
    ...
    this._clickRepulse = () => {
      ...
      const repulse = (_a = container2.repulse) != null ? _a : { particles: [] };
      if (!repulse.finish) {
        if (!repulse.count) {
          repulse.count = 0;
        }
    ...
    this._processRepulse = (position, repulseRadius, area, divRepulse) => {
      ...
      const { easing, speed, factor, maxSpeed } = repulseOptions, easingFunc = this._engine.getEasing(easing), velocity = ((_a = divRepulse == null ? void 0 : divRepulse.speed) != null ? _a : speed) * factor;
      for (const particle of query) {
  ...
  isEnabled(particle) {
    var _a;
    const container = this.container, options = container.actualOptions, mouse = container.interactivity.mouse, events = ((_a = particle == null ? void 0 : particle.interactivity) != null ? _a : options.interactivity).events, divs = events.onDiv, hover = events.onHover, click = events.onClick, divRepulse = isDivModeEnabled(repulseMode, divs);
...
function replaceImageColor(image, imageData, color, particle) {
  var _a, _b;
  const svgColoredData = replaceColorSvg(image, color, (_b = (_a = particle.opacity) == null ? void 0 : _a.value) != null ? _b : defaultOpacity3), imageRes = {
    color,
    gif: imageData.gif,
...
function drawGif(data) {
  ...
  if (particle.gifLoopCount === void 0) {
    particle.gifLoopCount = (_a = image.gifLoopCount) != null ? _a : defaultLoopCount;
  }
  let frameIndex = (_b = particle.gifFrame) != null ? _b : defaultFrame;
...
async function loadGifImage(image) {
  ...
  try {
    ...
    image.gifLoopCount = (_a = getGIFLoopAmount(image.gifData)) != null ? _a : defaultLoopCount;
...
var ImageDrawer = class {
  constructor(engine) {
    ...
    this.loadImageShape = async (imageShape) => {
      ...
      await this._engine.loadImage({
        ...
        replaceColor: (_a = imageShape.replaceColor) != null ? _a : false,
        src: imageShape.src
      });
    };
    this._engine = engine;
  ...
  particleInit(container, particle) {
    ...
    const replaceColor = (_a = imageData.replaceColor) != null ? _a : image.replaceColor;
    if (image.loading) {
      setTimeout(() => {
    ...
    void (async () => {
      ...
      if (image.svgData && color) {
        ...
        imageRes = {
          ...
          loaded: true,
          ratio: imageData.width && imageData.height ? imageData.width / imageData.height : (_a2 = image.ratio) != null ? _a2 : defaultRatio3,
          replaceColor,
          source: imageData.src
        };
      }
      ...
      const fill = (_b = imageData.fill) != null ? _b : particle.shapeFill, close = (_c = imageData.close) != null ? _c : particle.shapeClose, imageShape = {
        image: imageRes,
        fill,
        close
      };
...
var Linker = class extends ParticlesInteractorBase {
  ...
  interact(p1) {
    ...
    const linkOpt1 = p1.options.links, optOpacity = linkOpt1.opacity, optDistance = (_a = p1.retina.linksDistance) != null ? _a : minDistance6, warp = linkOpt1.warp;
    let range;
    if (warp) {
...
var LinkInstance = class {
  constructor(container, engine) {
    this._drawLinkLine = (p1, link) => {
      ...
      container2.canvas.draw((ctx) => {
        ...
        const width = (_b = p1.retina.linksWidth) != null ? _b : minWidth, maxDistance = (_c = p1.retina.linksDistance) != null ? _c : minDistance7, { backgroundMask } = options;
        drawLinkLine({
          context: ctx,
          width,
          begin: pos1,
    ...
    this._drawLinkTriangle = (p1, link1, link2) => {
      ...
      const container2 = this._container, options = container2.actualOptions, p2 = link1.destination, p3 = link2.destination, opacityTriangle = (_a = triangleOptions.opacity) != null ? _a : (link1.opacity + link2.opacity) * half11;
      if (opacityTriangle <= minOpacity2) {
        return;
      }
      container2.canvas.draw((ctx) => {
        var _a2;
        const pos1 = p1.getPosition(), pos2 = p2.getPosition(), pos3 = p3.getPosition(), linksDistance = (_a2 = p1.retina.linksDistance) != null ? _a2 : minDistance7;
  ...
  drawParticle(context, particle) {
    ...
    for (const link of p1Links) {
      ...
      if (link.opacity > minOpacity2 && ((_a = particle.retina.linksWidth) != null ? _a : minWidth) > minWidth) {
...
var PolygonDrawerBase = class {
  ...
  getSidesCount(particle) {
    ...
    return Math.round(getRangeValue((_a = polygon == null ? void 0 : polygon.sides) != null ? _a : defaultSides));
  }
};
...
function drawStar(data) {
  var _a;
  const { context, particle, radius } = data, sides7 = particle.sides, inset = (_a = particle.starInset) != null ? _a : defaultInset;
...
var StarDrawer = class {
  ...
  getSidesCount(particle) {
    ...
    return Math.round(getRangeValue((_a = star == null ? void 0 : star.sides) != null ? _a : defaultSides2));
  }
  particleInit(container, particle) {
    var _a;
    const star = particle.shapeData;
...
var StrokeColorUpdater = class {
  ...
  init(particle) {
    ...
    particle.strokeOpacity = getRangeValue((_a = stroke.opacity) != null ? _a : defaultOpacity4);
    particle.strokeAnimation = (_b = stroke.color) == null ? void 0 : _b.animation;
    const strokeHslColor = (_c = rangeColorToHsl(this._engine, stroke.color)) != null ? _c : particle.getFillColor();
    if (strokeHslColor) {
...
function drawText(data) {
  ...
  const text = particle.text, style = (_a = character.style) != null ? _a : "", weight = (_b = character.weight) != null ? _b : "400", size = Math.round(radius) * double15, font = (_c = character.font) != null ? _c : "Verdana", fill = particle.shapeFill;
...
function updateWobble(particle, delta) {
  ...
  const angleSpeed = wobble.angleSpeed * delta.factor, moveSpeed = wobble.moveSpeed * delta.factor, distance = moveSpeed * (((_a = particle.retina.wobbleDistance) != null ? _a : defaultDistance) * delta.factor) / (millisecondsToSeconds / distanceFactor), max = doublePI8, { position } = particle;
...
var WobbleUpdater = class {
  ...
  init(particle) {
    ...
    particle.retina.wobbleDistance = getRangeValue((_a = wobbleOpt == null ? void 0 : wobbleOpt.distance) != null ? _a : defaultDistance2) * this.container.retina.pixelRatio;
  }
  isEnabled(particle) {
    var _a;
