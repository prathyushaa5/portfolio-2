...
var Particles2 = class extends import_react.Component {
  ...
  shouldComponentUpdate(nextProps) {
    var _a, _b;
    const nextOptions = (_a = nextProps.options) != null ? _a : nextProps.params, currentOptions = (_b = this.props.options) != null ? _b : this.props.params;
  ...
  render() {
    ...
    return import_react.default.createElement("div", { className, id }, import_react.default.createElement("canvas", { className: canvasClassName, style: __spreadProps(__spreadValues({}, this.props.style), {
      width,
      height
    }) }));
  }
  ...
  async loadParticles() {
    ...
    const id = (_b = (_a = this.props.id) != null ? _a : Particles2.defaultProps.id) != null ? _b : defaultId, container = await tsParticles.load({
      url: this.props.url,
      id,
      options: (_c = this.props.options) != null ? _c : this.props.params
    });
...
// dep:react-tsparticles
var react_tsparticles_default = esm_default;
export {
  Particles_default as Particles,
  react_tsparticles_default as default
};
