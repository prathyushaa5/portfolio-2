...
const Project = () => {
  const projects = [
    ...
    ,{
      img:project6,
      name:"StockWise",
      github_link:"https://github.com/prathyushaa5/StockWise.git"
    },{
      img:project7,
      name:"AI Enhanced Fitness App",
      github_link:"https://github.com/prathyushaa5/MajorProject_.git"
    }
  ];
        ...
        <div className="w-full lg:w-2/3">
          ...
          >
            {projects.map((project_info, i) => (
              <SwiperSlide key={i}>
              <div className="h-[350px] w-full p-4 bg-slate-700 rounded-xl flex flex-col justify-between">
                <img 
